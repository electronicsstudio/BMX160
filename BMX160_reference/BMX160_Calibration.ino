...
float mag_offsets[3]            = { 0.77F, 40.34F, -6.00F };

// Soft iron error compensation matrix
float mag_softiron_matrix[3][3] = { {  +0.618,  -0.001, + 0.004 },
                                    {  -0.001,  +0.627, -0.009 },
                                    {  +0.004,  -0.009, +2.577 } };

float mag_field_strength        = 44.87F;
...
void loop(void)
{
  ...
  // Serial.print("$PMAG");
  // Serial.print(","); Serial.print(mx); Serial.print(",");
  // Serial.print(""); Serial.print(my); Serial.print(",");
  // Serial.print(""); Serial.print(mz); Serial.print("*");
  // // Serial.println("");
